...
const Login = () => {
   const navigates = useNavigate()
    ...
    const urlPath = "http://localhost:5020/";
    const handleLogin = (e) => {
        e.preventDefault();
        ...
        axios.post(urlPath+ 'admin', data).then((res) => {
            console.log("kkkkkkkkkkkkkkkk", res.data);
                            ...
                            <div className="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                                ...
                                <div className="d-flex justify-content-center py-4">
                                    <a href="index.html" className="logo d-flex align-items-center w-auto">
                                        ...
                                        <span className="d-none d-lg-block">BFC Capital (CMS) Login</span>
                                    </a>
                                </div>
                                ...
                                <div className="credits">
                                    ...
                                    Designed by <a href="https://bootstrapmade.com/">BFC Softtech</a>
                                </div>
